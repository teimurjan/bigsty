...
def get_email_ru_html_template(link):
    return '''
<!doctype html>
<html>
  <head>
  ...
  <body class="">
    <span class="preheader">Регистрация на eye8.kgю</span>
                ...
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p>Привет!</p>
                        <p>Вы всего в шаге от того, чтобы стать пользователем eye8. Нажмите на кнопку, чтобы продолжить.</p>
                            ...
                            <tr>
                              <td align="left">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href="''' + link + '''" target="_blank">Зарегистрироваться</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link">Бишкек, Кыргызстан</span>
                  </td>
                </tr>
                <tr>
...
def get_email_en_html_template(link):
    return '''
<!doctype html>
<html>
  <head>
          ...
          <div class="content">
                ...
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p>Hello!</p>
                        <p>You're almost eye8 user. Click to the button to proceed.</p>
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="btn btn-primary">
                          <tbody>
                            <tr>
                              <td align="left">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href="''' + link + '''" target="_blank">Sign Up</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
            ...
            <div class="footer">
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link">Bishkek, Kyrgyzstan</span>
                  </td>
                </tr>
                <tr>
                  <td class="content-block powered-by">
...
class SignupService:
    ...
    def create_and_send(self, data, language=None):
        ...
        body = (get_email_en_html_template if language.name == 'en-US' else get_email_ru_html_template)(link)
        subject = 'Complete registration' if language.name == 'en-US' else 'Завершение регистрации'
