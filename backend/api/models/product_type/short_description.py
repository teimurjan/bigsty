...
class ProductTypeShortDescription(IntlText):
    ...
    product_type = models.ForeignKey(ProductType, related_name="short_descriptions", related_query_name='short_description',
                                     on_delete=models.CASCADE)

    def to_dto(self):
        return ProductTypeShortDescriptionDTO(self.pk, self.product_type.pk, self.value, self.language.to_dto())
