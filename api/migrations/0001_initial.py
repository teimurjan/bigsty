# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-09-13 13:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('feature_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='feature_type', to='api.FeatureType')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='descriptions', to='api.ProductType')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.CharField(max_length=50)),
                ('language', models.ForeignKey(db_column='language', on_delete=django.db.models.deletion.CASCADE, to='api.Language')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='names', to='api.ProductType')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.CharField(max_length=100)),
                ('language', models.ForeignKey(db_column='language', on_delete=django.db.models.deletion.CASCADE, to='api.Language')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='short_descriptions', to='api.ProductType')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(db_column='group', on_delete=django.db.models.deletion.CASCADE, related_name='users', to='api.Group')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='featurevaluename',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='names', to='api.FeatureValue'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='featuretypename',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='names', to='api.FeatureType'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='categoryname',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='names', to='api.Category'),
        ),
    ]
