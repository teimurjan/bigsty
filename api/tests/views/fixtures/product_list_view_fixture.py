...
class ProductListViewFixture(IFixture):
  @staticmethod
  def make() -> None:
    category_1 = Category.objects.create()
    category_1.add_names({'en': 'Phone'})

    feature_type_1, feature_type_2 = ProductListViewFixture._create_feature_types(category_1)

    feature_value_1, feature_value_2, feature_value_3 = ProductListViewFixture._create_feature_values_1(feature_type_1)
    feature_value_4, feature_value_5, feature_value_6 = ProductListViewFixture._create_feature_values_2(feature_type_2)
    ...
    ProductListViewFixture._create_product(product_type_1, [feature_value_1, feature_value_4])
    ProductListViewFixture._create_product(product_type_1, [feature_value_1, feature_value_5])
    ProductListViewFixture._create_product(product_type_1, [feature_value_2, feature_value_4])
    ProductListViewFixture._create_product(product_type_1, [feature_value_2, feature_value_5])
