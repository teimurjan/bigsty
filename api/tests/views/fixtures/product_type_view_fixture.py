...
class ProductTypeViewFixture(IFixture):
  @staticmethod
  def make() -> None:
    ...
    feature_type_1, feature_type_2 = ProductTypeViewFixture._create_feature_types_1(category_1)

    feature_value_1, feature_value_2, feature_value_3 = ProductTypeViewFixture._create_feature_values_1(
      feature_type_1)
    feature_value_4, feature_value_5, feature_value_6 = ProductTypeViewFixture._create_feature_values_2(
      feature_type_2)
    feature_value_7, feature_value_8 = ProductTypeViewFixture._create_feature_values_3(feature_type_1)
    ...
    ProductTypeViewFixture._create_product(product_type_1, [feature_value_1, feature_value_4])
    ProductTypeViewFixture._create_product(product_type_1, [feature_value_1, feature_value_5])
    ProductTypeViewFixture._create_product(product_type_1, [feature_value_2, feature_value_4])
    ProductTypeViewFixture._create_product(product_type_1, [feature_value_2, feature_value_5])
    ProductTypeViewFixture._create_product(product_type_2, [feature_value_7, feature_value_4])
    ProductTypeViewFixture._create_product(product_type_2, [feature_value_8, feature_value_6])
