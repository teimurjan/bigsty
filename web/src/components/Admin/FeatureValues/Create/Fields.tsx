...
} from "./AdminFeatureValuesCreatePresenter";
...
const FeatureTypeSelect = injectIntl(
  ({
    ...
    input,
    meta
  }: IFeatureTypeSelectProps & InjectedIntlProps) => {
...
export const Fields = injectIntl(
  ({ availableLocales, intl , featureTypes }: IFieldsProps & InjectedIntlProps) => (
    <>
      <IntlField
      ...
      <Field
        ...
        render={getFeatureTypeSelectRenderer(featureTypes)}
      />
    </>
  )
);
