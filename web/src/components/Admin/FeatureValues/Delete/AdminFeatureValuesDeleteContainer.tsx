...
export const AdminFeatureValuesDeleteContainer = injectAdminFeatureValuesState(
  injectDependencies(({ dependencies, adminFeatureValuesState: { deleteFeatureValue } }: IProps) => {
    ...
    return (
      <DeleteModalContainer deleteEntity={deleteEntity} preloadData={preloadData} backPath="/admin/featureValues" />
    );
  }),
);
