...
const ConnectedAdminFeatureValuesListPresenter = injectIntlState(
  AdminFeatureValuesListPresenter
);

export const AdminFeatureValuesListContainer = injectAdminFeatureValuesState(
  props => (
    <ConnectedAdminFeatureValuesListPresenter
