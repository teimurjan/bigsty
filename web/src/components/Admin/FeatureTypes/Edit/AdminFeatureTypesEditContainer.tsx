...
import { AdminFeatureTypesEditPresenter, IProps } from './AdminFeatureTypesEditPresenter';
...
const ConnectedAdminFeatureTypesEditPresenter = injectIntlState(
  injectAdminFeatureTypesState(withRouter<IProps>(AdminFeatureTypesEditPresenter)),
);

export const AdminFeatureTypesEditContainer = injectDependencies(({ dependencies }) => (
