...
export const AdminFeatureTypesDeleteContainer = injectAdminFeatureTypesState(
  injectDependencies(({ dependencies, adminFeatureTypesState: { deleteFeatureType } }: IProps) => {
    ...
    return (
      <DeleteModalContainer deleteEntity={deleteEntity} preloadData={preloadData} backPath="/admin/featureTypes" />
    );
  }),
);
